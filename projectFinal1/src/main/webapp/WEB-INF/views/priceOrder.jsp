...
<script>
var productPrice = ${basket.productPrice};
var productName = ${basket.productName};
var productNo = ${basket.productNo};
var basketProductCount = ${basket.basketProductCount};
var memberId = ${basket.memberId};

  //실제 복사하여 사용시에는 모든 주석을 지운 후 사용하세요
  BootPay.request({
      price: 'productPrice', //실제 결제되는 가격
      ...
      items: [
          {
              ...
              qty: 'basketProductCount', //수량
              unique: 'productNo', //해당 상품을 구분짓는 primary key
              price: 'productPrice', //상품 단가
          }
      ],
