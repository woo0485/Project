...
<body>
	<div class="container text-center">
	 	<div class="row row-cols-6" id="myPageHeader">
	 		<div class="col">
				<i class="bi bi-person-badge-fill"></i>
		 			<a class="text-decoration-none fontblack" href="myPageMain?id=${sessionScope.id}">회원정보</a>
		 		</div>
	 		<div class="col">
		 		<i class="bi bi-minecart"></i>
		 			<a class="text-decoration-none fontblack" href="myPageReservation?id=${sessionScope.id}">예약관리</a>
		 		</div>
	 		<div class="col">
	 			<i class="bi bi-chat-square-dots"></i>
		 			<a class="text-decoration-none fontblack" href="myPageInquiry?id=${sessionScope.id}">회원문의</a>
		 		</div>
	 		<div class="col">
	 			<i class="bi bi-search-heart"></i>
	 					<a class="text-decoration-none fontblack" href="myPageFavorite?id=${sessionScope.id}">즐겨찾기</a>	 				
	 		</div>
	 		<div class="col">
	 			<i class="bi bi-ticket-perforated"></i>
		 			<a class="text-decoration-none fontblack" href="myPageCoupon?id=${sessionScope.id}">회원쿠폰</a>
		 		</div>
	 		<div class="col">
	 			<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-tencent-qq" viewBox="0 0 16 16">
		 			...
		 			<a class="text-decoration-none fontblack" href="myPageBenefit?id=${sessionScope.id}">회원혜택</a>
		 	</div>
	 	</div>
	 </div>	
</body>
