	...
	<div class="col-10 offset-1">
		...
		<div class="row">
			<div class="col-3 offset-9 mt-4 pe-0">
				<h5 class="ps-5">
					<a href="#" style="color: black;" id="galleryDateLatest"><span class="ps-4">• 최신순</span></a> 
				    <a href="#" style="color: black;" id="galleryDatePopularity"><span class="ps-4 opacity-25">• 인기순</span></a>
				</h5>
			</div>
		</div>
							...
							<div class="modal-body">
								<div id="carouselExampleIndicators${status.index}"
									...
									<div class="carousel-indicators">
										...
										<c:forEach var="index" begin="1" end="${fn:length(gallery.galleryimage) - 1}">
											<button type="button"
												data-bs-target="#carouselExampleIndicators${status.index}"
									...
									<div class="carousel-inner">
										...
										<div class="carousel-item">
											<img src="resources/upload/${gallery.galleryimage[index]}" class="d-block w-100" alt="..." style="height: 400px;">
										</div>
										</c:forEach>
									</div>
