						...
						<div class="row">
							<div class="col-6 offset-2 mb-3">
								...
								<div contenteditable="true" id="contenteditable"
									style="min-height: 50vh;" class="border rounded p-2"></div>
							</div>
						</div>
						<div class="row">
							<div class="col-6 offset-2 my-4 text-center">
								<input type="submit" value="등록하기" class="custom-btn btn-3 px-3 py-1" style="font-size:small;">&nbsp;&nbsp;
								<input type="button" value="뒤로가기" class="custom-btn btn-3 px-3 py-1" style="font-size:small;" onclick="history.back()">
							</div>
						</div>	
					</form>
				</div>
