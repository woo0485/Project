						...
						<table class="table table-hover">
							<thead>
								<tr class="table-danger">
									<td class="row">회원정보</td>
								</tr>
							</thead> 
							<tbody class="text-center">
								<c:if test="${sessionScope.id eq my.id}">	
									<tr>
										<th style="border:none; text-align:end;">회원등급</th>
									...
									<tr>
										<th style="border:none; text-align:end;" >아이디</th>
										<td style="border:none;">${my.id}</td>
									</tr>
									<tr>
										<th style="border:none; text-align:end;">비밀번호</th>
										<td style="border:none;">*****</td>
									</tr>
									<tr>
										<th style="border:none; text-align:end;">이름</th>
										<td style="border:none;">${my.name}</td>
									</tr>
									<tr>
										<th style="border:none; text-align:end;">이메일</th>
										<td style="border:none;">${my.email}</td>
									</tr>
									<tr>
										<th style="border:none; text-align:end;">휴대전화</th>
