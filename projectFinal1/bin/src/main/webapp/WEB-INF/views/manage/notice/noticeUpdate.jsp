...
<div class="row">
	...
	<div class="col-9 text-start mt-5">
		...
		<form name="noticeUpdateForm" id="noticeUpdateForm" action="noticeUpdateProcess"
			...
			<div class="row">
				<div class="col-6 offset-2  mb-3">
					...
					<div id="contenteditable" contenteditable="true"
						style="min-height: 50vh;" class="border rounded">${notice.noticeContent}
					</div>
				</div>
			</div>
			...
			<div class="col-5 offset-2  mb-5">
				<label>이미지 수정</label> <input type="file"
					...
					type="hidden" name="noticeImage" id="noticeImage">
			</div>
