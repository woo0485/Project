	...
	<div class="col">
		...
		<div class="row">
			...
			<div class="col-8 text-start mt-5">
				...
				<form id="checkForm" action="updateManageReservationProcess"
					name="manageReservationUpdateForm" id="manageReservationUpdateForm"
					method="post">
					<div class="row">
							...
							<table class="table table-hover">
									...
									<td>
										<div>
											<input type="text" class="form-control" name="reservationno"
												id="reservationno" placeholder="예약 번호"
									...
									<td>
										<div>
											<input type="text" class="form-control" name="id" id="id"
												placeholder="아이디" value="${reservation.id }"
												style="border-width: 0;">
										</div>
									</td>
								</tr>
									...
									<td>
										<div>
											<input type="text" class="form-control" name="productno"
												id="productno" placeholder="상품 번호"
												value="${reservation.productno }" style="border-width: 0;">
										</div>
									</td>
								</tr>
								<tr class="">
									...
									<td>
										<div>
											<input type="text" class="form-control"
												name="reservationprice" id="reservationprice"
												placeholder="예약 금액" value="${reservation.reservationprice }"
												style="border-width: 0;">
										</div>
									</td>
								</tr>
								<tr class="">
									...
									<td>
										<div>
											<input type="text" class="form-control"
												name="reservationticketcount" id="reservationticketcount"
												placeholder="티켓 수"
												value="${reservation.reservationticketcount }"
												style="border-width: 0;">
										</div>
									</td>
								</tr>
									...
									<td>
										<div>
											<input type="text" class="form-control"
												...
												placeholder="예약 날짜" value="${reservation.reservationdate }"
												style="border-width: 0;">
										</div>
									</td>
								</tr>
