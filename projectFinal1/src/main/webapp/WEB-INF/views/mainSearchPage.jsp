					...
					<div class="tab-content" id="pills-tabContent">
					  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
					  	...
					  	<div class="row border my-5">
					  		<div class="col">
					  		<!-- 축제정보 -->
						  		<c:if test="${empty mainSearchResult}">
						  	<div class="row">
							   <div class="col">
					    	...
					    	<div class="row">
						  	<c:if test="${not empty mainSearchResult}">
							  <c:forEach var="searchProduct" items="${mainSearchResult}" end="3">
							    <c:if test="${searchProduct.tableName == 'Product'}">
									<div class="col-3 my-2">
								  		<div class="card" style="width: 18rem;">
										 <a href="#"><img src="${searchProduct.itemImg}" class="card-img-top" alt="..." style="height: 250px;"></a> 
										  <div class="card-body" style="height: 170px;">
											  <div class="card-text"><a href="productDetail?no=${searchProduct.itemNo}">${searchProduct.itemTitle}</a></div>
											  <div class="card-text" style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; word-wrap:break-word;">
											 	<a href="productDetail?no=${searchProduct.itemNo}">${searchProduct.itemContent}</a> 
											  </div>
										  </div>
									  </div>
									</div>							    	
					  	...
					  	<div class="row border my-5">
						  	...
						  	<c:if test="${not empty mainSearchResult}">
							  	<c:forEach var="searchNews" items="${mainSearchResult}" end="3">
							  		 <c:if test="${searchNews.tableName == 'News'}">
										<div class="row mt-4 border-bottom">
											<div class="col-3" style="height: 200px;">
												<a href="newsdetail?no=${searchNews.itemNo}"> <img alt="" src="${searchNews.itemImg}"
											...
											<div class="col-9">
												<div class="row mt-4">
													<div class="col fs-3"
														...
														<a href="newsdetail?no=${searchNews.itemNo}" style="text-decoration: none; color: black;">${searchNews.itemTitle}</a>
													</div>
												</div>
												<div class="row mt-4">
													<div class="col fs-4 news-text-target"
														style="text-overflow: ellipsis; height: 102px;">
														<a href="newsdetail?no=${searchNews.itemNo}" style="text-decoration: none; color: black;"> ${searchNews.itemContent}</a>
													</div>
												</div>
											</div>
										</div>
					  	...
					  	<div class="row border my-5">
					  		...
					  		<!-- 갤러리 -->
						    	...
						    	<div class="row">
							  	<c:if test="${not empty mainSearchResult}">
								  <c:forEach var="searchGallery" items="${mainSearchResult}" end="3">
								    <c:if test="${searchGallery.tableName == 'Gallery'}">
										<div class="col-3 my-2">
									  		<div class="card" style="width: 18rem;">
											 <a href="roductDetail?productno=${searchGallery.itemNo}"><img src="resources/upload/${searchGallery.itemImg}" class="card-img-top" alt="..." style="height: 250px;"></a> 
											  <div class="card-body" style="height: 170px;">
												  <div class="card-text"><a href="productDetail?no=${searchGallery.itemNo}">${searchGallery.itemTitle}</a></div>
												  <div class="card-text" style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; word-wrap:break-word;">
												 	<a href="productDetail?no=${searchGallery.itemNo}">${searchGallery.itemContent}</a> 
												  </div>
											  </div>
										  </div>
										</div>							    	
					  ...
					  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
				    	...
				    	<div class="row">
					  	<c:if test="${not empty mainSearchResult}">
						  <c:forEach var="searchProduct" items="${mainSearchResult}">
						    <c:if test="${searchProduct.tableName eq 'Product'}">
								<div class="col-3 my-2">
							  		<div class="card" style="width: 18rem;">
									 <a href="#"><img src="${searchProduct.itemImg}" class="card-img-top" alt="..." style="height: 250px;"></a> 
									  <div class="card-body" style="height: 170px;">
					  ...
					  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
					  	...
					  	<c:if test="${not empty mainSearchResult}">
					  	<c:forEach var="searchNews" items="${mainSearchResult}">
					  		 <c:if test="${searchNews.tableName eq 'News'}">
								<div class="row mt-4">
					  ...
					  <div class="tab-pane fade" id="pills-disabled" role="tabpanel" aria-labelledby="pills-disabled-tab" tabindex="0">
					  	...
					  	<div class="row">
					  		...
					  		<!-- 갤러리 -->
						    	...
						    	<div class="row">
							  	<c:if test="${not empty mainSearchResult}">
								  <c:forEach var="searchGallery" items="${mainSearchResult}">
								    <c:if test="${searchGallery.tableName == 'Gallery'}">
										<div class="col-3 my-2">
									  		<div class="card" style="width: 18rem;">
											 <a href="roductDetail?productno=${searchGallery.itemNo}"><img src="resources/upload/${searchGallery.itemImg}" class="card-img-top" alt="..." style="height: 250px;"></a> 
